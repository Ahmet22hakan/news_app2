...
import 'package:news_app/blocs/category_tab6_bloc.dart';
...
class CategoryTab6 extends StatefulWidget {
  ...
  CategoryTab6({Key? key, required this.category}) : super(key: key);
...
class _CategoryTab6State extends State<CategoryTab6> {
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
      ...
      onLoad: () {
        context.read<CategoryTab6Bloc>().getMoreData(mounted, widget.category);
      },
