...
class RecentArticles7 extends StatefulWidget {
  RecentArticles7({Key? key}) : super(key: key);

  @override
  _RecentArticles7State createState() => _RecentArticles7State();
}

class _RecentArticles7State extends State<RecentArticles7> {
  @override
  Widget build(BuildContext context) {
    final rb = context.watch<RecentBloc7>();
