...
class RecentArticles2 extends StatefulWidget {
  RecentArticles2({Key? key}) : super(key: key);

  @override
  _RecentArticles2State createState() => _RecentArticles2State();
}

class _RecentArticles2State extends State<RecentArticles2> {
  @override
  Widget build(BuildContext context) {
    final rb = context.watch<RecentBloc2>();
