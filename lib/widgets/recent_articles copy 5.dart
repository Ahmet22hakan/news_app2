...
class RecentArticles5 extends StatefulWidget {
  RecentArticles5({Key? key}) : super(key: key);

  @override
  _RecentArticles5State createState() => _RecentArticles5State();
}

class _RecentArticles5State extends State<RecentArticles5> {
  @override
  Widget build(BuildContext context) {
    final rb = context.watch<RecentBloc5>();
