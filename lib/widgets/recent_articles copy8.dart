...
class RecentArticles8 extends StatefulWidget {
  RecentArticles8({Key? key}) : super(key: key);

  @override
  _RecentArticles8State createState() => _RecentArticles8State();
}

class _RecentArticles8State extends State<RecentArticles8> {
  @override
  Widget build(BuildContext context) {
    final rb = context.watch<RecentBloc8>();
