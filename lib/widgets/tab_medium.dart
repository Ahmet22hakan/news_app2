...
import 'package:news_app/tabs/category_tab6.dart';
import 'package:news_app/tabs/category_tab7.dart';
import 'package:news_app/tabs/category_tab8.dart';
    ...
    return TabBarView(
      children: <Widget>[
        ...
        CategoryTab4(
         ...
         CategoryTab6(
          category: Config().initialCategories[5],
        ),
         CategoryTab7(
          category: Config().initialCategories[6],
        ),
         CategoryTab8(
          category: Config().initialCategories[7],
        ),
      ],
