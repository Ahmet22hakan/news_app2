                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          decoration:
                              BoxDecoration(borderRadius: BorderRadius.circular(5), color: Colors.blueGrey[600]),
                          child: Text(
                            d.category!,
                    ...
                    child: Stack(
                      ...
                      children: [
                        Container(
                          ...
                          child:
                              Hero(tag: heroTag, child: CustomCacheImage(imageUrl: d.thumbnailImagelUrl, radius: 5.0)),
                        ),
                        VideoIcon(
